...
function PasswordForm() {
  ...
  const isFormValid =
    strength !== "faible" && passwordsMatch && !isSubmitting;
  ...
  return (
    <div className="flex flex-col gap-[11px] items-center px-10">
      <h2
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-[2px] w-full">
        <TextInput
          id="password"
          label="Mot de passe"
          value={password}
        ...
        {error && (
          <p className="text-sm text-[#F14662] mt-1" data-testid="register-error">
            {error}
          </p>
        )}
