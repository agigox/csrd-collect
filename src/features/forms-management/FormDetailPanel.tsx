...
export const FormDetailPanel = ({
  ...
  return (
    <div
      className="flex flex-col h-screen w-full sticky top-0 border-l bg-background pl-4"
      style={{
    ...
    >
      ...
      {/* Scrollable body - placeholder */}
      <div className="flex-1 overflow-y-auto p-6">
        <p className="text-muted-foreground">Contenu &agrave; venir</p>
      </div>
    </div>
  );
};
