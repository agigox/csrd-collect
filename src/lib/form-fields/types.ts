...
export type FieldType = "text" | "number" | "select" | "unit" | "switch" | "calendar";
...
export type FieldConfig = TextFieldConfig | NumberFieldConfig | SelectFieldConfig | UnitFieldConfig | SwitchFieldConfig | CalendarFieldConfig;
